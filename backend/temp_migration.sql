...
-- CreateIndex
CREATE INDEX "Item_customerId_idx" ON "Item"("customerId");
...
-- CreateIndex
CREATE INDEX "ItemReservation_itemId_idx" ON "ItemReservation"("itemId");

-- CreateIndex
CREATE INDEX "ItemReservation_sessionId_idx" ON "ItemReservation"("sessionId");

-- CreateIndex
CREATE INDEX "ItemReservation_reservedBy_idx" ON "ItemReservation"("reservedBy");

-- CreateIndex
CREATE INDEX "ItemReservation_expiresAt_idx" ON "ItemReservation"("expiresAt");

-- CreateIndex
CREATE UNIQUE INDEX "ItemReservation_itemId_sessionId_key" ON "ItemReservation"("itemId", "sessionId");
...
-- AddForeignKey
ALTER TABLE "ItemReservation" ADD CONSTRAINT "ItemReservation_reservedBy_fkey" FOREIGN KEY ("reservedBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
